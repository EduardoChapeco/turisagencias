...
export function PublicAiChat({ orgSlug, orgId, agencyName = 'Assistente', agencyColor = '#16a34a' }: PublicAiChatProps) {
 ...
 _token: localStorage.getItem('turis_b2c__token'),
 }
 });
 ...
 {isOpen && (
 <div
 className="w-[370px] max-h-[580px] flex flex-col rounded-2xl border border-zinc-200 bg-white overflow-hidden animate-in slide-in-from-bottom-4 duration-200"
 ...
 className="w-14 h-14 rounded-full text-white flex items-center justify-center transition-all hover:scale-105 active:scale-95"
