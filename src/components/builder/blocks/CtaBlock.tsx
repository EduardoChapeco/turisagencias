  ...
  renderComponent: ({ node }) => {
    ...
    return (
      <section className={`${paddingTop} ${paddingBottom} ${backgroundColor} ${textColor} px-6`}>
        <div className="max-w-5xl mx-auto bg-zinc-950 text-white rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10">
            ...
            <button className="px-10 py-5 bg-vj-green text-zinc-950 text-lg font-black rounded-2xl hover:scale-105 transition-transform shadow-xl">
              {buttonText}
            </button>
          </div>
        </div>
