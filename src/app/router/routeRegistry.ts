...
export const APP_ROUTES: AppRouteContract[] = [
  ...
  { id: 'admin-commissions', path: '/admin/commissions', component: 'CommissionReports', layout: 'admin_master', visibility: 'admin_secret', requiredRoles: ['org_admin','super_admin'], dataDependencies: ['agent_commission_entries'], tables: ['agent_commission_entries'], rlsCritical: true, breadcrumb: ['Admin', 'Comissões'] },
  { id: 'admin-support', path: '/admin/support', component: 'SupportAdmin', layout: 'app', visibility: 'private', requiredRoles: ['org_admin','super_admin','agent','support'], dataDependencies: ['tickets'], tables: ['tickets'], rlsCritical: true, breadcrumb: ['Admin', 'Suporte'] },
  { id: 'admin-blog', path: '/admin/blog', component: 'BlogAdmin', layout: 'app', visibility: 'private', requiredRoles: ['org_admin','super_admin'], dataDependencies: ['news_articles'], tables: ['news_articles'], rlsCritical: true, breadcrumb: ['Admin', 'Blog'] },
