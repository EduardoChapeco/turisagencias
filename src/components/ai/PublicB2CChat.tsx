...
export function PublicB2CChat({ orgId }: PublicB2CChatProps) {
 ...
 <Button
 onClick={handleOpen}
 className="fixed bottom-6 right-6 h-14 w-14 rounded-full bg-zinc-950 hover:bg-zinc-800 text-white transition-all duration-300 z-50 flex items-center justify-center"
 >
 ...
 {isOpen && (
 <div className="fixed bottom-6 right-6 w-[350px] sm:w-[400px] h-[600px] max-h-[80vh] bg-white rounded-2xl border border-zinc-200 flex flex-col z-50 overflow-hidden font-sans">
 {/* Header */}
 ...
 <div className="bg-white border border-zinc-200 rounded-2xl rounded-tl-sm p-4 flex items-center gap-2">
