...
export default function TravelerCheckinPortal() {
 ...
 toast.error("Erro ao conectar com a companhia: " + err.message);
 } finally {
 ...
 return (
 <div className="min-h-screen bg-slate-900 flex flex-col items-center justify-center p-4">
 <div className="w-full max-w-md bg-slate-800 rounded-2xl p-6 text-center border border-slate-700 space-y-4">
 ...
 {/* Hero Card */}
 <div className="relative bg-gradient-to-br from-indigo-950 via-slate-900 to-slate-950 rounded-2xl border border-indigo-500/20 overflow-hidden p-6">
 ...
 className="w-full h-14 text-base bg-emerald-600 hover:bg-emerald-700 text-white font-semibold transition-all rounded-xl">
 {generatingLink ? (
 <>
