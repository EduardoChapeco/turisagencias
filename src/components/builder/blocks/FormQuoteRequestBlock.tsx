    ...
    return (
      <section className={`${paddingTop} ${paddingBottom} ${backgroundColor} ${textColor} px-6`}>
        <div className="max-w-2xl mx-auto p-8 bg-white rounded-2xl shadow-xl border border-zinc-100">
          ...
          <form className="w-full grid grid-cols-1 md:grid-cols-2 gap-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="md:col-span-2 mt-4">
              <button className="w-full px-8 py-4 bg-zinc-950 text-white font-black rounded-xl hover:bg-zinc-800 transition-colors">
                {buttonText}
              </button>
            </div>
          </form>
