...
export function FichaClienteMaster() {
 ...
 disabled={isSaving}
 className="bg-emerald-600 hover:bg-emerald-700 text-white h-10 px-5 rounded-xl font-bold "
 >
 ...
 <div key={`pag-${i}`} className="a4-ficha-page bg-white w-[800px] h-[1131px] p-16 shrink-0 flex flex-col border border-slate-200 relative">
 ...
 <div className="a4-ficha-page bg-white w-[800px] h-[1131px] p-16 shrink-0 flex flex-col border border-slate-200 relative">
 <div className="border-b-2 border-black pb-4 mb-8 flex justify-between items-end">
 <div>
 <h1 className="text-[26px] font-black uppercase text-black leading-none tracking-tighter">{AGENCY_NAME}</h1>
