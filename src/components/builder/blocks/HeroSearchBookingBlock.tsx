...
export const HeroSearchBookingBlock: BlockDef = {
 ...
 <form onSubmit={handleSearch} className="w-full bg-white rounded-2xl p-4 flex flex-col md:flex-row gap-4 items-center">
 ...
 <button type="submit" className="w-full md:w-auto bg-vj-green hover:bg-emerald-600 text-white rounded-xl px-8 py-4 flex items-center justify-center font-bold transition-colors ">
