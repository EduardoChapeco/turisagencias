  ...
  renderComponent: ({ data }: any) => (
    <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-purple-600 to-indigo-600 text-white p-8 shadow-lg">
      <div className="absolute top-0 right-0 p-4">
        <div className="bg-yellow-400 text-yellow-900 text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wide shadow-sm">
      ...
      <div className="max-w-xs relative z-10">
        ...
        <button className="bg-white text-indigo-700 font-semibold px-6 py-2 rounded-lg hover:bg-gray-50 transition-colors shadow-sm">
