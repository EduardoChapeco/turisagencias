...
export const CtaStickyBottomBlock: BlockDef = {
  ...
  renderComponent: ({ node }) => {
    ...
    return (
      <div className={`fixed bottom-0 left-0 w-full z-50 ${backgroundColor} ${textColor} shadow-[0_-4px_20px_rgba(0,0,0,0.1)] border-t border-white/10`}>
        <div className="px-4 py-3 flex flex-col sm:flex-row items-center justify-between max-w-4xl mx-auto gap-3">
          ...
          <button className="w-full sm:w-auto px-6 py-2.5 bg-green-500 text-white font-bold rounded-lg hover:bg-green-600 transition-colors shadow-lg">
            {buttonText}
          </button>
        </div>
      </div>
