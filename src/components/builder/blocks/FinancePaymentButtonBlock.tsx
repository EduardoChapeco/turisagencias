      ...
      <div className="flex flex-col items-center gap-3 p-6 max-w-md mx-auto">
        ...
        {hasValidUrl ? (
          <a 
            ...
            className="flex items-center justify-center gap-2 w-full bg-vj-green hover:bg-emerald-600 text-white font-bold py-4 px-6 rounded-xl transition-all shadow-lg hover:shadow-xl hover:-translate-y-1"
          >
            <CreditCard size={20} />
            {buttonText}
          </a>
