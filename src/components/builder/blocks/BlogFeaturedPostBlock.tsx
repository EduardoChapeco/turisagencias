  ...
  renderComponent: ({ node }) => {
    ...
    return (
      <div className={`${paddingTop} ${paddingBottom} px-6 w-full flex justify-center`}>
        <div className="w-full max-w-4xl flex flex-col md:flex-row gap-8 bg-white rounded-2xl overflow-hidden border border-zinc-100 shadow-sm group hover:shadow-md transition-shadow">
