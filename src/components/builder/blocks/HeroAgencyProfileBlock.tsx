      ...
      <section className={`${paddingTop} ${paddingBottom} ${backgroundColor} ${textColor} relative`}>
        ...
        <div className="max-w-4xl mx-auto px-6 relative -mt-16 md:-mt-24">
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            <div className="w-32 h-32 md:w-40 md:h-40 rounded-full border-4 border-white shadow-xl overflow-hidden bg-white mb-4">
            ...
            <div className="w-full flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              ...
              <button className="px-6 py-3 bg-[#25D366] hover:bg-[#20bd5a] text-white font-bold rounded-xl flex items-center justify-center gap-2 transition-colors shadow-md w-full md:w-auto">
