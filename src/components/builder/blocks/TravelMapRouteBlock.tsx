...
export const TravelMapRouteBlock: BlockDef = {
 ...
 />
 <div className="w-full h-[400px] bg-slate-200 rounded-3xl overflow-hidden border border-slate-300 relative ">
 <div className="absolute inset-0 bg-black/10 z-10"></div>
 <div className="absolute inset-0 flex items-center justify-center z-20 pointer-events-none">
 <div className="bg-white/90 backdrop-blur px-6 py-3 rounded-full font-bold flex items-center gap-2">
