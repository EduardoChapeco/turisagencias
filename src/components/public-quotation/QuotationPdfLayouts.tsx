...
export function PdfTemplateExecutivo({ data }: Props) {
 return (
 <div className="bg-white text-zinc-900 min-h-screen p-12 max-w-4xl mx-auto print:p-0 print:max-w-none" style={{ fontFamily: 'Outfit, sans-serif' }}>
 {/* HEADER */}
...
export function PdfTemplateApresentacao({ data }: Props) {
 ...
 return (
 <div className="bg-white text-zinc-900 min-h-screen print:bg-white print:m-0" style={{ fontFamily: 'Outfit, sans-serif' }}>
...
export function PdfTemplateExceTur({ data }: Props) {
 return (
 <div className="bg-[#0a0a0a] text-white min-h-screen p-12 max-w-4xl mx-auto font-sans print:p-0 print:max-w-none print:bg-black" style={{ fontFamily: 'Outfit, sans-serif' }}>
