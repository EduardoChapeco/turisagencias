      ...
      <section className={`${paddingTop} ${paddingBottom} ${backgroundColor} ${textColor} px-6 relative overflow-hidden flex flex-col items-center justify-center text-center`}>
        ...
        <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 md:gap-8 mb-12">
            {[
              ...
              <div key={time.label} className="flex flex-col items-center">
                <div className="bg-white text-red-600 w-16 h-16 md:w-24 md:h-24 rounded-2xl flex items-center justify-center text-3xl md:text-5xl font-black shadow-xl mb-2">
          ...
          <EditableText
            ...
            value={buttonText}
            as="button"
            className="px-10 py-5 bg-zinc-900 hover:bg-black text-white font-black uppercase tracking-wider rounded-xl transition-transform hover:scale-105 shadow-2xl"
          />
        </div>
      </section>
    );
