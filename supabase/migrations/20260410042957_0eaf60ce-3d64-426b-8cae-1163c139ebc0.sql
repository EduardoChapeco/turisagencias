...
CREATE TRIGGER set_ai_keys_pool_updated_at
  BEFORE UPDATE ON public.ai_keys_pool FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();
...
CREATE TRIGGER set_destination_guides_updated_at
  BEFORE UPDATE ON public.destination_guides FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();
