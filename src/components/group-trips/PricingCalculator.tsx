...
export function PricingCalculator({ groupTripId }: PricingCalculatorProps) {
 ...
 <Card className="p-8 rounded-[2rem] border-white/60 bg-white/60 backdrop-blur-md _8px_30px_rgb(0,0,0,0.04)]">
 ...
 <Card className="p-8 rounded-[2rem] border-white/60 bg-white/80 backdrop-blur-md _8px_30px_rgb(0,0,0,0.06)] sticky top-20">
 ...
 <Button 
 className="w-full mt-6 h-12 rounded-xl text-md font-bold hover:scale-[1.02] active:scale-95 transition-all duration-300 _4px_20px_rgb(0,0,0,0.1)]" 
 size="lg" 
 onClick={handleSave} 
