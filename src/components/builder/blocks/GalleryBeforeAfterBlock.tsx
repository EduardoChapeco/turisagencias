    ...
    return (
      <div style={node.styles} className="w-full flex justify-center">
        {!imageBefore || !imageAfter ? (
          ...
          <div 
            ref={containerRef}
            className="w-full max-w-4xl aspect-[16/9] relative rounded-xl overflow-hidden shadow-lg select-none cursor-ew-resize group"
          ...
          >
            ...
            <div className="absolute inset-0">
              ...
              {labelAfter && (
                <div className="absolute top-4 right-4 bg-black/60 text-white px-3 py-1 text-sm font-bold rounded-md backdrop-blur-sm shadow">
                  {labelAfter}
                </div>
              )}
            </div>
            ...
            >
              ...
              {labelBefore && (
                <div className="absolute top-4 left-4 bg-black/60 text-white px-3 py-1 text-sm font-bold rounded-md backdrop-blur-sm shadow">
                  {labelBefore}
                </div>
              )}
            </div>
            ...
            >
              <div className="w-8 h-8 bg-white rounded-full flex items-center justify-center shadow-[0_0_10px_rgba(0,0,0,0.5)] border border-gray-200">
