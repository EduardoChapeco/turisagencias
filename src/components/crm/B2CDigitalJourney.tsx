...
export function B2CDigitalJourney({ clientId }: { clientId: string }) {
 ...
 <div className="flex items-center justify-center w-10 h-10 rounded-full border border-white bg-zinc-100 text-zinc-500 shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 z-10">
 {getEventIcon(ev.event_type)}
 </div>
 <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white p-3 rounded-2xl border border-zinc-100 ">
