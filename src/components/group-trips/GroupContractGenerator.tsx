...
export function GroupContractGenerator({ groupTripId }: GroupContractGeneratorProps) {
 ...
 <Card className="p-6 rounded-[2rem] border-white/60 bg-white/60 backdrop-blur-md _8px_30px_rgb(0,0,0,0.04)]">
 ...
 {selectedClient && (
 <Button 
 className="w-full gap-2 h-12 rounded-xl text-md font-bold hover:scale-[1.02] active:scale-95 transition-all duration-300 _4px_20px_rgb(0,0,0,0.1)]" 
 size="lg" 
 onClick={generatePDF} 
 ...
 style={{ width: '210mm', minHeight: '297mm', color: '#000', fontFamily: 'Outfit, sans-serif' }}
 >
