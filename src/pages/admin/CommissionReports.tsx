          ...
          {isLoading ? (
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <Card className="shadow-none border-vj-border bg-blue-50/30">
                  <CardContent className="p-6 flex items-center justify-between">
                    <div>
                ...
                <Card className="shadow-none border-vj-border bg-amber-50/30">
                  <CardContent className="p-6 flex items-center justify-between">
                    <div>
              ...
              <Card className="shadow-none border-vj-border overflow-hidden">
