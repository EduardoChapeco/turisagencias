...
const targetDir = 'C:\\Users\\aline\\.gemini\\antigravity\\brain\\08c1643f-bcf3-4020-94b8-feae3553199d';
...
// -------------------------------------------------------------
writeFile('00_ONBOARDING_INVENTARIO.md', `# 00 - Inventário do Onboarding Atual
...
// -------------------------------------------------------------
writeFile('01_ONBOARDING_UI_DB_MATCH.md', `# 01 - Matriz UI ↔ API ↔ DB do Onboarding Atual
...
// -------------------------------------------------------------
writeFile('02_ONBOARDING_EDGE_FUNCTIONS_MATCH.md', `# 02 - Onboarding e Integração com Supabase Edge Functions
...
// -------------------------------------------------------------
writeFile('03_ONBOARDING_DESIGN_AUDIT.md', `# 03 - Auditoria Estética e Design System (Bento Grid OMEGA v4.0)
...
// -------------------------------------------------------------
writeFile('04_PUBLIC_PAGE_BASIC_MODE.md', `# 04 - Ativação Essencial: Canal Público Básico da Agência
...
// -------------------------------------------------------------
writeFile('05_SITE_BUILDER_ARCHITECTURE.md', `# 05 - Arquitetura de Builder Visual Baseado em Projetos JSON
...
// -------------------------------------------------------------
writeFile('06_BLOG_CMS_ARCHITECTURE.md', `# 06 - CMS do Blog: Curadoria e Publicação Estruturada
...
// -------------------------------------------------------------
writeFile('07_LINKBIO_ARCHITECTURE.md', `# 07 - Construtor de Link-Bio de Alta Conversão
...
// -------------------------------------------------------------
writeFile('08_PORTAL_CLIENTE_ONBOARDING.md', `# 08 - Configuração Avançada do Portal do Cliente
...
// -------------------------------------------------------------
writeFile('09_AIRPORTS_AIRLINES_CHECKIN_REGISTRY.md', `# 09 - Catálogo de Aeroportos e Links de Check-in
...
// -------------------------------------------------------------
writeFile('10_ADMIN_SECRETS_RBAC.md', `# 10 - Gerenciamento de Secrets e Controle RBAC do Admin
...
// -------------------------------------------------------------
writeFile('11_SEGURANCA_ONBOARDING_PUBLIC_SURFACES.md', `# 11 - Segurança e Blindagem de Superfícies Públicas
...
// -------------------------------------------------------------
writeFile('12_PRD_ONBOARDING_REWRITE.md', `# 12 - PRD Operacional do Novo Onboarding de Dupla Velocidade
...
// -------------------------------------------------------------
writeFile('13_ROADMAP_ONBOARDING_P0_P1_P2_P3.md', `# 13 - Roadmap do Novo Onboarding e Builder
...
// -------------------------------------------------------------
writeFile('14_PLANO_DE_PRS_ONBOARDING.md', `# 14 - Plano de Pull Requests Incrementais
...
console.log('Successfully written all 15 PRD files!');
