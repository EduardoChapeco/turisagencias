        ...
        <div className="max-w-6xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="flex flex-col items-start order-2 lg:order-1">
            ...
            <div className="w-full max-w-sm">
              <button className="w-full px-6 py-4 bg-zinc-900 hover:bg-black text-white font-bold rounded-xl flex items-center justify-between transition-colors shadow-lg group">
          ...
          <div className="order-1 lg:order-2 w-full h-[300px] lg:h-[500px] rounded-3xl overflow-hidden shadow-2xl relative">
            <div 
