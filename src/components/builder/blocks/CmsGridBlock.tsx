      ...
      <div className="max-w-6xl mx-auto">
        ...
        {!loading && !error && items.length > 0 && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {items.map((item, i) => (
              <article key={item.id || i} className="bg-white rounded-2xl overflow-hidden border border-zinc-100 hover:border-zinc-300 transition-all hover:shadow-sm group">
                {item[imgCol] && (
