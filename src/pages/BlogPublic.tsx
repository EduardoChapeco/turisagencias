...
export default function BlogPublic() {
 ...
 className="pl-12 h-12 rounded-xl text-zinc-900 border-0 bg-white "
 />
 </div>
 </div>
 ...
 <Card
 key={post.id}
 className="border-zinc-200 overflow-hidden cursor-pointer hover: hover:-translate-y-0.5 transition-all duration-200 group"
