...
export const AirlineBoardingPassButtonBlock: BlockDef = {
 ...
 value={buttonText}
 as="button"
 className="w-full max-w-md px-6 py-4 bg-vj-green text-zinc-950 font-bold rounded-xl hover:brightness-95 transition-all flex items-center justify-center gap-2"
 />
 </div>
 );
 },
