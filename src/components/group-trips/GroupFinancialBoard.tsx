...
export function GroupFinancialBoard({ groupTripId }: GroupFinancialBoardProps) {
 ...
 <Card className="p-6 rounded-[2rem] border-white/60 bg-white/60 backdrop-blur-md _8px_30px_rgb(0,0,0,0.04)] hover:-translate-y-1 transition-all duration-300">
 ...
 <Card className="p-6 rounded-[2rem] border-vj-green/20 bg-vj-green/5 backdrop-blur-md _8px_30px_rgb(0,0,0,0.04)] hover:-translate-y-1 transition-all duration-300">
 ...
 <Card className="p-6 rounded-[2rem] border-red-100 bg-red-50/80 backdrop-blur-md _8px_30px_rgb(0,0,0,0.04)] hover:-translate-y-1 transition-all duration-300">
 ...
 <div className="flex flex-col sm:flex-row gap-4 bg-white/60 backdrop-blur-md p-4 rounded-[1.5rem] border border-white/60 _4px_20px_rgb(0,0,0,0.03)] items-center justify-between">
 ...
 <Card className="overflow-hidden border-white/60 bg-white/60 backdrop-blur-md _8px_30px_rgb(0,0,0,0.04)] rounded-[2rem]">
 ...
 size="sm"
 variant="outline"
 className="h-9 rounded-xl text-xs font-bold border-emerald-500/30 text-emerald-600 hover:bg-emerald-600 hover:text-white hover:scale-[1.02] active:scale-95 transition-all duration-300 "
 onClick={() => {
 if (clientObj) {
 ...
 size="sm" 
 variant="outline" 
 className="h-9 rounded-xl text-xs font-bold border-vj-green/30 text-vj-green hover:bg-vj-green hover:text-white hover:scale-[1.02] active:scale-95 transition-all duration-300 "
