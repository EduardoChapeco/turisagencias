...
export const TravelDynamicPriceBadgeBlock: BlockDef = {
 ...
 <div className="absolute right-0 -top-20 bg-white rounded-2xl border border-zinc-100 p-6 flex flex-col md:flex-row items-center gap-6 pointer-events-auto z-50">
 <div>
 <EditableText
 nodeId={node.id}
 propKey="prefix"
