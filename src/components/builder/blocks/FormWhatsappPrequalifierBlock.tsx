      ...
      <section className={`${paddingTop} ${paddingBottom} ${backgroundColor} ${textColor} px-6`}>
        <div className="max-w-md mx-auto text-center">
          ...
          <form className="w-full space-y-4 text-left" onSubmit={(e) => e.preventDefault()}>
            ...
            <button className="w-full px-8 py-4 bg-green-600 text-white font-bold rounded-xl hover:bg-green-700 transition-colors mt-2 flex items-center justify-center gap-2">
