...
export function VoucherPipeline({ groupTripId }: VoucherPipelineProps) {
 ...
 <Card className="p-8 rounded-[2rem] border-dashed border-2 border-vj-blue/30 bg-white/60 backdrop-blur-md _8px_30px_rgb(0,0,0,0.04)] flex flex-col items-center justify-center text-center hover:border-vj-blue/60 transition-colors">
 ...
 {voucherData && (
 <Card className="p-6 rounded-[2rem] border-vj-green/30 bg-vj-green/5 backdrop-blur-md _8px_30px_rgb(0,0,0,0.04)]">
 ...
 <Button onClick={exportVoucher} className="mt-4 w-full gap-2 h-12 rounded-xl text-md font-bold hover:scale-[1.02] active:scale-95 transition-all duration-300 _4px_20px_rgb(0,0,0,0.1)]" disabled={isRendering}>
 ...
 <div 
 ref={voucherRef}
 className="relative w-[380px] h-[675px] bg-[#0F1C2E] text-white rounded-3xl overflow-hidden flex flex-col"
 ...
 {/* Loc ID */}
 <div className="bg-[#D4A017] text-[#0F1C2E] p-3 rounded-xl font-bold flex justify-between items-center ">
