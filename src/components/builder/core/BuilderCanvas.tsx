...
export function BuilderCanvas() {
 ...
 viewport === 'tablet' && "w-[768px] my-8 rounded-2xl overflow-hidden shadow-none border-zinc-200",
 viewport === 'mobile' && "w-[375px] my-8 rounded-[2rem] overflow-hidden border-[12px] border-zinc-800 shadow-none"
 )}>
