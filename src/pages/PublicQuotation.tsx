...
export default function PublicQuotation() {
 ...
 <button onClick={() => window.print()} className="fixed bottom-6 left-6 z-50 bg-white border border-vj-border rounded-full p-4 hover:scale-105 transition-transform flex items-center gap-2 text-sm font-bold">
